...
mt1_cmd = ['python', 'languages.py', '--embeddings_dim', '32', '--hiddens_dim', '32' ,'--model', 'lstm', '--dataset', 'nc_zhen', '--task', 'mt', '--batch_size', '8' ,'--use_cuda', 'True']
mt2_cmd = ['python', 'languages.py', '--model', 'transformer', '--dataset', '--embeddings_dim', '32', '--hiddens_dim', '32',  'nc_zhen', '--task', 'mt', '--batch_size', '8', '--use_cuda', 'True']
