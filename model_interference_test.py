...
lm_cmd = ['python', 'languages.py', '--model', 'lstm', '--task', 'lm', '--dataset', 'wikitext', '--use_cuda', 'True', '--embeddings_dim', '128', '--max_len', '80', '--hiddens_dim', '128', '--drop_out', '0.2', '--bidrectional', 'True', '--batch_size', '32', '--max_epochs', '3']
