...
### Table of contents
- [https://github.com/lukemelas/EfficientNet-PyTorch](#httpsgithubcomlukemelasefficientnet-pytorch)
- [EfficientNet PyTorch](#efficientnet-pytorch)
    - [Table of contents](#table-of-contents)
    - [About EfficientNet](#about-efficientnet)
    - [About EfficientNet PyTorch](#about-efficientnet-pytorch)
