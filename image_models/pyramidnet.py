# From https://github.com/dyhan0920/PyramidNet-PyTorch
...
def pyramidnet_84_66(dataset, num_classes, **kwargs):
    return PyramidNet(dataset, 66, 84, num_classes, **kwargs)

def pyramidnet_48_110(dataset, num_classes, **kwargs):
    return PyramidNet(dataset, 110, 48, num_classes, **kwargs)

def pyramidnet_84_110(dataset, num_classes, **kwargs):
    return PyramidNet(dataset, 110, 84, num_classes, **kwargs)

def pyramidnet_270_110_bottleneck(dataset, num_classes, **kwargs):
    return PyramidNet(dataset, 110, 270, num_classes, bottleneck=True, **kwargs)